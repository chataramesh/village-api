...
public class EntityController {
    ...
    public ResponseEntity<List<Entity_Item>> getEntitiesByStatus(@PathVariable com.example.demo.enums.EntityStatus status) {
    ...
    public ResponseEntity<EntitySubscription> subscribeToEntity(
    ...
    public ResponseEntity<Boolean> isUserSubscribedToEntity(
            @PathVariable UUID entityId,
            @PathVariable UUID userId) {
    ...
    public ResponseEntity<EntityNotification> sendNotificationToEntity(
            @PathVariable UUID entityId,
